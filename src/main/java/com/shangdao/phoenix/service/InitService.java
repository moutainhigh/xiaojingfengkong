...
public class InitService {
	...
	private void init() {
		...
		if (userCount == 0) {
			...
			admin.setNotReadMessage(0);
			admin.setBackend(true);
...
//				weixinService.setupRoles();
		    ...
		    long userCount1 = userRepository.countBySource(Source.WXWORK);
		    if(userCount1 == 0){
		        weixinService.setupUsers();
		    }
		}
...
//			}
	...
	private HashMap<String, Act> initActs(EntityManager entityManager) {
		...
		act1.setAllCan(true);
		act1.setCreatorCan(false);
		act1.setManagerCan(false);
		act1.setMemberCan(false);
		act1.setDepartmentCan(false);
		act1.setSubscriberCan(false);
		act1.setListVisable(false);
		act1.setDetailVisable(false);
		act1.setCancelOtherNotice(false);
		...
		act2.setAllCan(true);
		act2.setCreatorCan(false);
		act2.setManagerCan(false);
		act2.setMemberCan(false);
		act2.setDepartmentCan(false);
		act2.setSubscriberCan(false);
		act2.setListVisable(false);
		act2.setDetailVisable(false);
		act2.setCancelOtherNotice(false);
		...
		act3.setAllCan(true);
		act3.setCreatorCan(false);
		act3.setManagerCan(false);
		act3.setMemberCan(false);
		act3.setDepartmentCan(false);
		act3.setSubscriberCan(false);
		act3.setListVisable(false);
		act3.setDetailVisable(false);
		act3.setCancelOtherNotice(false);
		...
		act4.setAllCan(true);
		act4.setCreatorCan(false);
		act4.setManagerCan(false);
		act4.setMemberCan(false);
		act4.setDepartmentCan(false);
		act4.setSubscriberCan(false);
		act4.setListVisable(false);
		act4.setDetailVisable(false);
		act4.setCancelOtherNotice(false);
		...
		act5.setAllCan(true);
		act5.setCreatorCan(false);
		act5.setManagerCan(false);
		act5.setMemberCan(false);
		act5.setDepartmentCan(false);
		act5.setSubscriberCan(false);
		act5.setListVisable(false);
		act5.setDetailVisable(false);
		act5.setCancelOtherNotice(false);
		...
		act6.setAllCan(true);
		act6.setCreatorCan(false);
		act6.setManagerCan(false);
		act6.setMemberCan(false);
		act6.setDepartmentCan(false);
		act6.setSubscriberCan(false);
		act6.setListVisable(false);
		act6.setDetailVisable(false);
		act6.setCancelOtherNotice(false);
		...
		act7.setAllCan(true);
		act7.setCreatorCan(false);
		act7.setManagerCan(false);
		act7.setMemberCan(false);
		act7.setDepartmentCan(false);
		act7.setSubscriberCan(false);
		act7.setListVisable(false);
		act7.setDetailVisable(false);
		act7.setCancelOtherNotice(false);
