...
public class WorkWeixinLoginService {
	...
	public Authentication workWeixinAuthorize(String code) {
		...
		if (user == null || user.getDeletedAt() != null) {
			throw new OutsideRuntimeException(ExceptionResultEnum.USER_NOT_EXIST);
		}
	...
	public String getWorkWeixinOAuthURL() {
		if (!workEnable) {
			throw new OutsideRuntimeException(ExceptionResultEnum.WXWORK_NOT_READY);
		}
	...
	protected Map _getTemplate(String url , String agentid, String secret) {
		if (!workEnable) {
			throw new OutsideRuntimeException(ExceptionResultEnum.HAVE_NO_WORKWX_FUNCTION);
		}
