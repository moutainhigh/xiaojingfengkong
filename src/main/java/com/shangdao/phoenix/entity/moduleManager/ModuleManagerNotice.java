 ...
 */
@Entity
@Table(name = "module_manager_notice")
public class ModuleManagerNotice implements INoticeLog<ModuleManager, ModuleManagerLog> {
    /**
     *
     */
    @Transient
    ...
    @Override
    public ModuleManagerLog getLog() {
        return log;
    }

    @Override
    public void setLog(ModuleManagerLog log) {
        this.log = log;
    }
