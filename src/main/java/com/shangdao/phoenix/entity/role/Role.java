...
public class Role implements IBaseEntity, Serializable {
    ...
    @ManyToMany
    @JoinTable(name = "role_button", joinColumns = {@JoinColumn(name = "role_id")}, inverseJoinColumns = {
    ...
    public Role(EntityManager entityManager,String code,String name,String note){
        this.name = name;
        this.code = code;
