...
import com.shangdao.phoenix.entity.company.CompanyLog;
 ...
 */
@Entity
@Table(name = "company_apply_form_notice")
public class CompanyApplyFormNotice implements INoticeLog<CompanyApplyForm,CompanyApplyFormLog> {
    ...
    private CompanyApplyFormLog log;
    ...
    @Override
    public CompanyApplyFormLog getLog() {
        return log;
    }

    @Override
    public void setLog(CompanyApplyFormLog log) {
        this.log = log;
    }
